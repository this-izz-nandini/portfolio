    ...
    <footer className='w-full pt-20 pb-10 mb-[100px] md:mb-5' id='contact'>
        ...
        <div className="flex flex-col items-center">
            ...
            <p className="text-white-200 md:mt-10 my-5 text-center">
                Contact me to discuss potential job opportunities and career growth.
            </p>
            <a href="mailto:nandinijindal321@gmail.com">
                <MagicButton title="Let's get in touch " icon={<FiMail/>} position='right'/>
            </a>
        </div>
